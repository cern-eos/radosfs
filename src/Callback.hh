...
public:
  ...
  Callback(callback_t tocall, CallbackData& info) { call = tocall; data = info; data.retc=0; }
  Callback(callback_t tocall, void* callerinfo) { call = tocall; data.caller = callerinfo; data.retc=0; }
